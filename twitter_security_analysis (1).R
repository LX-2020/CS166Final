...
twitterData_combined$user/favourites_count <- as.factor(twitterData_combined$user/favourites_count)
...
twitterData_combined$user/time_zone <- as.factor(twitterData_combined$user/time_zone)
twitterData_combined$user/translator_type <- as.factor(twitterData_combined$user/translator_type)
twitterData_combined$user/url <- as.factor(twitterData_combined$user/url)
twitterData_combined$user/utc_offset <- as.factor(twitterData_combined$user/utc_offset)
twitterData_combined$user/verified <- as.factor(twitterData_combined$user/verified)
twitterData_combined$user/want_retweets <- as.factor(twitterData_combined$user/want_retweets)
twitterData_combined$user_mentions/ten_plus_name <- as.factor(twitterData_combined$user_mentions/ten_plus_name)
twitterData_combined$user_mentions/ten_plus_screen_name <- as.factor(twitterData_combined$user_mentions/ten_plus_screen_name)
twitterData_combined$user_mentions/twnty_plus_name <- as.factor(twitterData_combined$user_mentions/twnty_plus_name)
twitterData_combined$user_mentions/twnty_plus_screen_name <- as.factor(twitterData_combined$user_mentions/twnty_plus_screen_name)
twitterData_combined$user_mentions/thrty_plus_name <- as.factor(twitterData_combined$user_mentions/thrty_plus_name)
twitterData_combined$user_mentions/thrty_plus_screen_name <- as.factor(twitterData_combined$user_mentions/thrty_plus_screen_name)
twitterData_combined$user_mentions/frty_plus_name <- as.factor(twitterData_combined$user_mentions/frty_plus_name)
twitterData_combined$user_mentions/frty_plus_screen_name <- as.factor(twitterData_combined$user_mentions/frty_plus_screen_name)
twitterData_combined$user_mentions/ffty_plus_name <- as.factor(twitterData_combined$user_mentions/ffty_plus_name)
twitterData_combined$user_mentions/ffty_plus_screen_name <- as.factor(twitterData_combined$user_mentions/ffty_plus_screen_name)
